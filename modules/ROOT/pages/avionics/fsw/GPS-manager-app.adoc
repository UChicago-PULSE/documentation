...
* link:communication-manager-app.html[Communication Manager Application]: Sends GPS commands and receives GPS module data
* link:ADCS-manager-app.html[ADCS Manager Application]: Provides position data
...
* link:cFS-sfotware-bus.html[Software Bus]: Publishes GPS topic data
