...
<div style="border:1px solid #ccc;">
  <div style="padding:0.5em; background-color:#f5f5f5; border-bottom:1px solid #ccc;">
    <a href="../../_images/PAT_Diagram.svg" download="PAT_Diagram.svg" style="text-decoration:none; background-color:#007cba; color:white; padding:0.5em 1em; border-radius:4px; font-size:0.9em;">📥 Download SVG</a>
  </div>
