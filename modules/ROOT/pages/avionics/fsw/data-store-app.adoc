...
* **All PULSE-A Applications**: Stores software bus messages from all applications (see link:index.html#obc-applications[OBC Applications] and link:index.html#payload-controller-applications[Payload Controller Applications] sections)
...
* **All NASA cFS Applications**: Stores software bus messages from all applications (see link:index.html#nasa-provided-cfs-applications[NASA Provided cFS Applications] section)
