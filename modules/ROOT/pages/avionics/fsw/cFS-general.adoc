...
* link:communication-manager-app.html[Communication Manager Application] - Serves as the primary interface to the CAN bus and backup I2C bus, preventing message collisions and handling queuing and prioritization
